...
<div class="page-container">
 <div class="row cl"  id="nameParentDiv1" style="margin-top:20px;margin-left:20px;" > 	<label class="form-label col-xs-4 col-sm-2">旧密码
</label>
...
<input type="password" class="input-text"  placeholder="请输入旧密码" id="password1" name="password1">
 ...
 <div class="row cl"  id="nameParentDiv2" style="margin-top:20px;margin-left:20px;" > 	<label class="form-label col-xs-4 col-sm-2">新密码
</label>
<div class="formControls col-xs-8 col-sm-9">
<input type="password" class="input-text"  placeholder="请输入新密码" id="password2" name="password2">
</div>
</div>
 <div class="row cl"  id="nameParentDiv" style="margin-top:20px;margin-left:20px;" > 	<label class="form-label col-xs-4 col-sm-2">确认密码
</label>
<div class="formControls col-xs-8 col-sm-9">
