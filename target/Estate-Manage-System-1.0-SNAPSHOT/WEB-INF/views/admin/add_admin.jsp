                                ...
                                <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/hui/static/h-ui.admin/skin/default/skin.css" id="skin" />
                                    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/hui/static/h-ui.admin/css/style.css" />
                                        ...
                                        <input type="text" class="input-text"  style="width:500px;display:inline"  placeholder="请输入登录密码" id="passWord">
                                            ...
                                            <div class="row cl" id="adminPerson" style="margin-top:20px;margin-left:20px;" >
                                                <label class="form-label col-xs-4 col-sm-2">
                                                    注册人
                                                </label>
                                                <div class="formControls col-xs-8 col-sm-9">
                                                    <input type="text" class="input-text"  style="width:500px;display:inline" value="${login.name}" id="admin">
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/hui/static/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer /作为公共模版分离出去-->
                                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=9990"></script>
                                                            ...
                                                            function submitData(){
                                                                ...
                                                                $.ajax({
                                                                    type: 'post',
                                                                    url: '${pageContext.request.contextPath}/commonapi/add_submit',
                                                                    data:{
                                                                        "name":name,
                                                                        "passWord":passWord
                                                                    },
